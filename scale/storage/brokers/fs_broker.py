...
class NfsBroker(Broker):
    ...
    def cleanup_download_dir(self, download_dir, work_dir):
        ...
        #nfs_umount(work_dir)
        logger.info('Inside cleanup_download_dir: This would unmount %s', work_dir)
    ...
    def cleanup_upload_dir(self, upload_dir, work_dir):
        ...
        #nfs_umount(work_dir)
        logger.info('Inside cleanup_upload_dir: This would unmount %s', work_dir)
    ...
    def delete_files(self, work_dir, workspace_paths):
        ...
        logger.info('Inside delete_files: This would mount %s', work_dir)
        ...
        #finally:
            #nfs_umount(work_dir)
        logger.info('Inside delete_files: This would unmount %s', work_dir)
    ...
    def load_config(self, config):
        ...
        logger.info('Inside load_config: Loading the %s configuration', config)
    ...
    def move_files(self, work_dir, files_to_move):
        ...
        #nfs_mount(self.mount, work_dir, False)
        logger.info('Inside move_files: This would mount %s', work_dir)
        ...
        logger.info('Inside move_files: This would unmount %s', work_dir)    
    ...
    def setup_download_dir(self, download_dir, work_dir):
        ...
        logger.info('Inside setup_download_dir: This would mount %s', work_dir)
    ...
    def upload_files(self, upload_dir, work_dir, files_to_upload):
        ...
        nfs_mount(self.mount, work_dir, False)
        logger.info('Inside upload_files: This would mount %s', work_dir)
        ...
        logger.info('Inside upload_files: This would unmount %s', work_dir)
